# Enhanced Prompt - Environment Strategy Document

## Use Case

Use this prompt to create or update the **Environment Strategy Document** as a professional SDLC Word document with valid Mermaid diagrams.

## Prompt

You are a senior SDLC documentation expert, enterprise architect, and technical documentation lead.

Create or update the **Environment Strategy Document** directly as a Word document.
...
Purpose of this document: **define environment purpose, ownership, promotion path, data rules, access, refresh, and stability controls**.
...
1. Updated **Environment Strategy Document** Word document.
