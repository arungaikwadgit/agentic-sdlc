# Enhanced Prompt - Rollback Plan

## Use Case

Use this prompt to create or update the **Rollback Plan** as a professional SDLC Word document with valid Mermaid diagrams.

## Prompt

You are a senior SDLC documentation expert, enterprise architect, and technical documentation lead.

Create or update the **Rollback Plan** directly as a Word document.
...
Purpose of this document: **define rollback triggers, decision authority, rollback steps, data handling, validation, and communication**.
...
1. Updated **Rollback Plan** Word document.
