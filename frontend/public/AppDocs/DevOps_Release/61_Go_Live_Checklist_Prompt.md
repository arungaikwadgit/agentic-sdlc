# Enhanced Prompt - Go Live Checklist

## Use Case

Use this prompt to create or update the **Go Live Checklist** as a professional SDLC Word document with valid Mermaid diagrams.

## Prompt

You are a senior SDLC documentation expert, enterprise architect, and technical documentation lead.

Create or update the **Go Live Checklist** directly as a Word document.
...
Purpose of this document: **define go-live readiness, activities, owners, validation points, communication, rollback readiness, and support model**.
...
1. Updated **Go Live Checklist** Word document.
