# Enhanced Prompt - Defect Management Plan

## Use Case

Use this prompt to create or update the **Defect Management Plan** as a professional SDLC Word document with valid Mermaid diagrams.

## Prompt

You are a senior SDLC documentation expert, enterprise architect, and technical documentation lead.

Create or update the **Defect Management Plan** directly as a Word document.
...
Purpose of this document: **define defect lifecycle, severity, priority, triage, ownership, SLA, reporting, and closure rules**.
...
1. Updated **Defect Management Plan** Word document.
