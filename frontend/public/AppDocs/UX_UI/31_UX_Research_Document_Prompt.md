# Enhanced Prompt - UX Research Document

## Use Case

Use this prompt to create or update the **UX Research Document** as a professional SDLC Word document with valid Mermaid diagrams.

## Prompt

You are a senior SDLC documentation expert, enterprise architect, and technical documentation lead.

Create or update the **UX Research Document** directly as a Word document.
...
Purpose of this document: **capture user research, personas, pain points, needs, usability findings, and design implications**.
...
1. Updated **UX Research Document** Word document.
