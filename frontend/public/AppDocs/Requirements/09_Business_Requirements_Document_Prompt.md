# Enhanced Prompt - Business Requirements Document

## Use Case

Use this prompt to create or update the **Business Requirements Document** as a professional SDLC Word document with valid Mermaid diagrams.

## Prompt

You are a senior SDLC documentation expert, enterprise architect, and technical documentation lead.

Create or update the **Business Requirements Document** directly as a Word document.
...
Purpose of this document: **capture business objectives, processes, stakeholders, business rules, acceptance expectations, and traceability**.
...
- Current to target process flow
...
1. Updated **Business Requirements Document** Word document.
