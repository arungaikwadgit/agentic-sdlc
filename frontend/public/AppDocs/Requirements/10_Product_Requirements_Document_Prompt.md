# Enhanced Prompt - Product Requirements Document

## Use Case

Use this prompt to create or update the **Product Requirements Document** as a professional SDLC Word document with valid Mermaid diagrams.

## Prompt

You are a senior SDLC documentation expert, enterprise architect, and technical documentation lead.

Create or update the **Product Requirements Document** directly as a Word document.
...
Purpose of this document: **define product goals, user needs, features, priorities, personas, success metrics, and release scope**.
...
1. Updated **Product Requirements Document** Word document.
