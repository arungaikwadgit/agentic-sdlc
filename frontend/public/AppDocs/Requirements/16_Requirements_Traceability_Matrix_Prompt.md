# Enhanced Prompt - Requirements Traceability Matrix

## Use Case

Use this prompt to create or update the **Requirements Traceability Matrix** as a professional SDLC Word document with valid Mermaid diagrams.

## Prompt

You are a senior SDLC documentation expert, enterprise architect, and technical documentation lead.

Create or update the **Requirements Traceability Matrix** directly as a Word document.
...
Purpose of this document: **connect business requirements, functional requirements, technical design, test cases, defects, and release scope**.
...
1. Updated **Requirements Traceability Matrix** Word document.
