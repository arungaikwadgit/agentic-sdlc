...
import { Dexie as Dexie$1, liveQuery } from "./dexie.js";
...
function usePermissions(firstArg, table, obj) {
	...
	if (arguments.length >= 3) {
		...
		if (firstArg instanceof Dexie$1) throw new TypeError("Invalid arguments to usePermission(db, table, obj): Missing table and obj arguments.");
