# Enhanced Prompt - Assumptions and Constraints Document

## Use Case

Use this prompt to create or update the **Assumptions and Constraints Document** as a professional SDLC Word document with valid Mermaid diagrams.

## Prompt

You are a senior SDLC documentation expert, enterprise architect, and technical documentation lead.

Create or update the **Assumptions and Constraints Document** directly as a Word document.
...
Purpose of this document: **document assumptions, constraints, impact, validation owner, mitigation, and open decisions**.
...
- Assumption validation flow
- Constraint impact map
...
1. Updated **Assumptions and Constraints Document** Word document.
