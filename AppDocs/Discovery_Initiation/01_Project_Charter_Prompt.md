# Enhanced Prompt - Project Charter

## Use Case

Use this prompt to create or update the **Project Charter** as a professional SDLC Word document with valid Mermaid diagrams.

## Prompt

You are a senior SDLC documentation expert, enterprise architect, and technical documentation lead.

Create or update the **Project Charter** directly as a Word document.
...
Purpose of this document: **define the project purpose, success measures, scope boundaries, governance, risks, assumptions, and delivery ownership**.
...
1. Updated **Project Charter** Word document.
