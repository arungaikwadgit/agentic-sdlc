# Enhanced Prompt - Scope Statement

## Use Case

Use this prompt to create or update the **Scope Statement** as a professional SDLC Word document with valid Mermaid diagrams.

## Prompt

You are a senior SDLC documentation expert, enterprise architect, and technical documentation lead.

Create or update the **Scope Statement** directly as a Word document.
...
Purpose of this document: **define clear scope boundaries, inclusions, exclusions, constraints, deliverables, and change control**.
...
1. Updated **Scope Statement** Word document.
