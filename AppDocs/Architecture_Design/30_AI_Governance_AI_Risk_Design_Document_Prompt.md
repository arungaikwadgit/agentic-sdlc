# Enhanced Prompt - AI Governance AI Risk Design Document

## Use Case

Use this prompt to create or update the **AI Governance AI Risk Design Document** as a professional SDLC Word document with valid Mermaid diagrams.

## Prompt

You are a senior SDLC documentation expert, enterprise architect, and technical documentation lead.

Create or update the **AI Governance AI Risk Design Document** directly as a Word document.
...
Purpose of this document: **define AI governance controls, risk classification, model use, human oversight, audit, compliance, and responsible AI controls**.
...
1. Updated **AI Governance AI Risk Design Document** Word document.
