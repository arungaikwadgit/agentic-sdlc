# Enhanced Prompt - Infrastructure Architecture Document

## Use Case

Use this prompt to create or update the **Infrastructure Architecture Document** as a professional SDLC Word document with valid Mermaid diagrams.

## Prompt

You are a senior SDLC documentation expert, enterprise architect, and technical documentation lead.

Create or update the **Infrastructure Architecture Document** directly as a Word document.
...
Purpose of this document: **define cloud infrastructure, network boundaries, compute, storage, environments, access, resilience, and operations**.
...
1. Updated **Infrastructure Architecture Document** Word document.
