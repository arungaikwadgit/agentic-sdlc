# Enhanced Prompt - Integration Design Document

## Use Case

Use this prompt to create or update the **Integration Design Document** as a professional SDLC Word document with valid Mermaid diagrams.

## Prompt

You are a senior SDLC documentation expert, enterprise architect, and technical documentation lead.

Create or update the **Integration Design Document** directly as a Word document.
...
Purpose of this document: **define system integrations, protocols, contracts, events, dependencies, failures, retries, and ownership**.
...
1. Updated **Integration Design Document** Word document.
