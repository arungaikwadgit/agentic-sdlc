# Enhanced Prompt - Low Level Design

## Use Case

Use this prompt to create or update the **Low Level Design** as a professional SDLC Word document with valid Mermaid diagrams.

## Prompt

You are a senior SDLC documentation expert, enterprise architect, and technical documentation lead.

Create or update the **Low Level Design** directly as a Word document.
...
Purpose of this document: **define implementable module-level design, APIs, data contracts, classes, validations, errors, and sequence flows**.
...
1. Updated **Low Level Design** Word document.
