# Enhanced Prompt - CI CD Design Document

## Use Case

Use this prompt to create or update the **CI CD Design Document** as a professional SDLC Word document with valid Mermaid diagrams.

## Prompt

You are a senior SDLC documentation expert, enterprise architect, and technical documentation lead.

Create or update the **CI CD Design Document** directly as a Word document.
...
Purpose of this document: **define build, test, security scan, artifact, deployment, approval, rollback, and environment promotion pipeline**.
...
1. Updated **CI CD Design Document** Word document.
