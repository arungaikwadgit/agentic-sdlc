# Enhanced Prompt - Production Readiness Checklist

## Use Case

Use this prompt to create or update the **Production Readiness Checklist** as a professional SDLC Word document with valid Mermaid diagrams.

## Prompt

You are a senior SDLC documentation expert, enterprise architect, and technical documentation lead.

Create or update the **Production Readiness Checklist** directly as a Word document.
...
Purpose of this document: **define readiness checks across code, infra, security, data, testing, monitoring, support, and business approval**.
...
1. Updated **Production Readiness Checklist** Word document.
