# Enhanced Prompt - Coding Standards Document

## Use Case

Use this prompt to create or update the **Coding Standards Document** as a professional SDLC Word document with valid Mermaid diagrams.

## Prompt

You are a senior SDLC documentation expert, enterprise architect, and technical documentation lead.

Create or update the **Coding Standards Document** directly as a Word document.
...
Purpose of this document: **define coding conventions, quality rules, security rules, review criteria, and maintainability expectations**.
...
1. Updated **Coding Standards Document** Word document.
