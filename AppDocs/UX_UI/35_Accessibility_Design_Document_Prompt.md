# Enhanced Prompt - Accessibility Design Document

## Use Case

Use this prompt to create or update the **Accessibility Design Document** as a professional SDLC Word document with valid Mermaid diagrams.

## Prompt

You are a senior SDLC documentation expert, enterprise architect, and technical documentation lead.

Create or update the **Accessibility Design Document** directly as a Word document.
...
Purpose of this document: **define accessibility requirements, WCAG mapping, interaction patterns, testing approach, and remediation workflow**.
...
1. Updated **Accessibility Design Document** Word document.
