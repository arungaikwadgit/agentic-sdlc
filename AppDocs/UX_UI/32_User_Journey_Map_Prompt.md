# Enhanced Prompt - User Journey Map

## Use Case

Use this prompt to create or update the **User Journey Map** as a professional SDLC Word document with valid Mermaid diagrams.

## Prompt

You are a senior SDLC documentation expert, enterprise architect, and technical documentation lead.

Create or update the **User Journey Map** directly as a Word document.
...
Purpose of this document: **map user goals, steps, emotions, touchpoints, pain points, opportunities, and target-state experience**.
...
1. Updated **User Journey Map** Word document.
